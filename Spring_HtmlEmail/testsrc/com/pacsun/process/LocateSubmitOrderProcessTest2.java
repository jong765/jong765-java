...
public class LocateSubmitOrderProcessTest2 {
	...
	public String writeStyle() throws FileNotFoundException {
		FileInputStream fis = new FileInputStream(
				"C:/eclipse workspace jk/Spring_HtmlEmail/Custom/QUA/Locate/email/css/email2.css");
	...
	public String writeHeader() throws FileNotFoundException {
		FileInputStream fis = new FileInputStream(
				"C:/eclipse workspace jk/Spring_HtmlEmail/Custom/QUA/Locate/email/template/header2.html");
