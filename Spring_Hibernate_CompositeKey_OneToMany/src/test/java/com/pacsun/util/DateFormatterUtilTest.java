...
public class DateFormatterUtilTest {
	...
	@Test
	public void testNumericDateTime() {
		int currentDate = Integer.parseInt(DateFormatterUtil.formatDate(new Date(), "yyyyMMdd"));
		System.out.println(currentDate);
		String currentTime = DateFormatterUtil.getCurrentTime();
