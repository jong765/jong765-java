...
@XmlType(name = "complexType.Product.BundledProducts", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31", propOrder = {
    "bundledProduct"
})
public class ComplexTypeProductBundledProducts {

    @XmlElement(name = "bundled-product", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
