...
@XmlType(name = "complexType.AttributeDefinition", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31", propOrder = {
    "displayName",
    "description",
    "type",
    "localizableFlag",
...
public class ComplexTypeAttributeDefinition {
    ...
    @XmlElement(name = "localizable-flag", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Boolean localizableFlag;
    @XmlElement(name = "site-specific-flag", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Boolean siteSpecificFlag;
    @XmlElement(name = "mandatory-flag", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Boolean mandatoryFlag;
    @XmlElement(name = "visible-flag", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Boolean visibleFlag;
    @XmlElement(name = "externally-managed-flag", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Boolean externallyManagedFlag;
    @XmlElement(name = "min-length", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Integer minLength;
    @XmlElement(name = "field-length", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Integer fieldLength;
    @XmlElement(name = "field-height", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Integer fieldHeight;
    @XmlElement(namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected List<SharedTypeLocalizedString> unit;
    @XmlElement(namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Integer scale;
    @XmlElement(name = "min-value", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Double minValue;
    @XmlElement(name = "max-value", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Double maxValue;
    @XmlElement(namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected String regex;
    @XmlElement(name = "select-multiple-flag", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected Boolean selectMultipleFlag;
    @XmlElement(name = "value-definitions", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
