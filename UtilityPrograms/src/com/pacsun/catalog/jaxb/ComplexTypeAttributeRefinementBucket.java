...
@XmlType(name = "complexType.AttributeRefinementBucket", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31", propOrder = {
    "displayName",
    "valueList",
    "presentationId",
    "description"
...
public class ComplexTypeAttributeRefinementBucket {
    ...
    @XmlElement(name = "value-list", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected List<SharedTypeLocalizedText> valueList;
    @XmlElement(name = "presentation-id", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
