...
@XmlType(name = "complexType.Option.Value", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31", propOrder = {
    "displayValue",
    "productIdModifier",
    "optionValuePrices"
})
public class ComplexTypeOptionValue {
    ...
    @XmlElement(name = "product-id-modifier", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
    protected String productIdModifier;
    @XmlElement(name = "option-value-prices", namespace = "http://www.demandware.com/xml/impex/catalog/2006-10-31")
