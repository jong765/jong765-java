...
@XmlType(name = "complexType.Header", namespace = "http://www.demandware.com/xml/impex/inventory/2007-05-31", propOrder = {
    "defaultInstock",
    "description",
...
public class ComplexTypeHeader {
    ...
    @XmlElement(name = "default-instock", namespace = "http://www.demandware.com/xml/impex/inventory/2007-05-31")
    protected boolean defaultInstock;
    @XmlElement(namespace = "http://www.demandware.com/xml/impex/inventory/2007-05-31")
    protected String description;
    @XmlElement(name = "use-bundle-inventory-only", namespace = "http://www.demandware.com/xml/impex/inventory/2007-05-31")
